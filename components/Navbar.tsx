...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 z-[1000] bg-primary-normal flex items-center justify-between w-full h-60 md:h-90 bg-primary-normal text-white">
      <nav className="md:mr-60 lg:mr-0 h-full">
      <ul className="min-h-full h-fit w-full flex flex-wrap bg-primary-normal pb-4 md:pb-0">
